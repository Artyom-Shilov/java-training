...
public class JpaControllerFactory implements BaseControllerFactory{

    private final SpaceRepository spaceRepository = new JpaSpaceRepository();
    private final CurrentUserRepository currentUserRepository = new CurrentUserRepositoryImpl();
    private final GlobalUserRepository globalUserRepository = new JpaGlobalUserRepository();
    private final ReservationRepository reservationRepository = new JpaReservationRepository();
    ...
    private static final JpaControllerFactory instance = new JpaControllerFactory();

    public static JpaControllerFactory getInstance(){
        return instance;
    }

    private JpaControllerFactory(){}
